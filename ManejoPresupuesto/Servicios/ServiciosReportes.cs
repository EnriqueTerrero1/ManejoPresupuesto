...
namespace ManejoPresupuesto.Servicios
{
    ...
    public interface IServicioReportes
    {
        ...
        Task<ReporteTransaccionesDetalladas> ObtenerReporteTransaccionesDetalladasPorCuentas(int usuarioId, int cuentaId, int mes, int año, dynamic ViewBag);
    }
    public class ServiciosReportes:IServicioReportes
    {
        ...
        public ServiciosReportes(IRepositorioTransacciones repositorioTransacciones  ,IHttpContextAccessor httpContextAccesor)
        {
        ...
        public async Task<ReporteTransaccionesDetalladas> ObtenerReporteTransaccionesDetalladasPorCuentas(int usuarioId, int cuentaId, int mes, int año, dynamic ViewBag)
        {
